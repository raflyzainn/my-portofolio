  ...
  return (
    <section className="relative pt-28 pb-20 text-center overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-20">
        <div className="absolute inset-x-0 -top-24 h-80 animated-gradient
        ...
        <div className="absolute left-1/2 top-4 h-64 w-64 -translate-x-1/2 rounded-full
      ...
      >
        ...
        <motion.p
          variants={fadeUp(.16)}
          className="mt-2 text-lg sm:text-xl text-slate-300"
        >
          I'm{" "}
          <Typing
        ...
        >
          I create clean and accessible interfaces that are visually engaging, easy to navigate, and designed to make an impact.
        </motion.p>
        ...
        >
          ...
          >
            Download CV
            <span className="ml-2 inline-block h-5 w-[2px] bg-white/30 align-middle"></span>
